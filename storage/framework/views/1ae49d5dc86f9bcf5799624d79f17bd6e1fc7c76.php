      ...
      <div id="page-wrapper" ng-controller="adminProductsController as vm">
        ...
        <div class="row" id="escolha">
          <div class="col-md-6" style="text-align: center">
            ...
            <img alt="Bootstrap Image Preview" src="https://i.pinimg.com/736x/d7/1f/ff/d71fff466bb69c1a453c13ac72469c6b--education-clipart-game-boards.jpg" class="img-circle" ng-click="vm.showManualBasket();" />
          </div>
          <div class="col-md-6" style="text-align: center">
            <h3 class="text-center">
              Create a random basket.
            </h3>
            <img alt="Bootstrap Image Preview" src="https://i.pinimg.com/736x/d7/1f/ff/d71fff466bb69c1a453c13ac72469c6b--education-clipart-game-boards.jpg" class="img-circle" ng-click="vm.showRandomBasket();" />
          </div>
        </div>
        <br>
        <br>
