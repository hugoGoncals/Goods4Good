      ...
      <div id="page-wrapper" ng-controller="adminProductsController as vm">
        ...
        <div class="row" id="escolha">
          <div class="col-md-6" style="text-align: center">
            ...
            <img src="<?php echo e(asset('imgs/logos/logo.png')); ?>"  alt="Bootstrap Image Preview" ng-click="vm.showManualBasket();"/>
          </div>
          <div class="col-md-6" style="text-align: center">
            <h3 class="text-center">
              Create a random basket.
            </h3>
            <img src="<?php echo e(asset('imgs/logos/logo.png')); ?>"  alt="Bootstrap Image Preview" ng-click="vm.showRandomBasket();"/>
          </div>
        </div>
        <br>
        <br>
