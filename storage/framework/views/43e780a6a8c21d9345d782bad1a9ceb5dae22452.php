...
<body id="page-top" class="index" ng-controller="ProductbasketController as vm" ng-init="vm.inicio(<?php echo e(Auth::user()); ?>)" style="background-color: #eeeeee  !important">
