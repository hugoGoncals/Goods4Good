        ...
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
            <div class="col-sm-6 col-md-4" style=" margin-top: 25px;margin-left:25px;">
               <img  style="width: 130px;"src="{{Auth::user()->avatar}}" class="img-circle" >
            </div>
            <div class="col-sm-6 col-md-8" style="margin-left:-150px;">
              <h2>{{Auth::user()->name}}</h2><br>
              <span class="glyphicon glyphicon-envelope one" style="width:30px;"></span> {{Auth::user()->email}}<br>
              <span class="glyphicon glyphicon-gift" style="width:30px;"></span>  {{Auth::user()->age}}<br>
              <span class="glyphicon glyphicon-user one" style="width:30px;"></span> {{Auth::user()->gender}}<br>
              <span class="glyphicon glyphicon-map-marker one" style="width:30px;"></span> {{Auth::user()->location}}<br>
              <br>
            </div>
        ...
        <div class="modal-body">
          <div class="form-group">  
            ...
            <label for="gender" class="col-md-4 control-label">Gender</label>
              <div class="col-md-6">
                <input id="gender" type="text" class="form-control" ng-model="gender" value="{{ old('gender') }}">
              </div>
            </div>
            ...
            <div>
              ...
              <div class="col-md-6">
                <input id="age" class="form-control" type="text" value="{{ old('age') }}" ng-model="age">
              </div>
            </div>
            ...
            <div>
              ...
              <div class="col-md-6">
                <input id="location" type="text" class="form-control" ng-model="location" value="{{ old('location') }}">
              </div>
            </div>
