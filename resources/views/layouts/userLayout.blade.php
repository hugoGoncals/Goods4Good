...
<html lang="{{ config('app.locale') }}" ng-app="providerRecords">
    <head>
        ...
        <script src="{{asset('/angular/controllers/userController.js')}}"></script>  
         <script src="{{asset('/angular/controllers/listDonationUser.js')}}"></script>  

        <script src="{{asset('/angular/controllers/badgetController.js')}}"></script>  
    </head>
    <body>
        <div id="wrapper">
          <!-- Sidebar -->
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
              <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
                ...
                <a href="/inicio" class="logo">Goods4Good</a>
            </div>
