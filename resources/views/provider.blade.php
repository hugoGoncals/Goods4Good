						...
						<div class="modal-body">
							<form name="frmEmployees" class="form-horizontal" novalidate="">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" maxlength="9" class="form-control" id="pass" name="pass" placeholder="Password" value="@{{pass}}" ng-model="provider.pass" ng-required="true">
								 
											<button type="button" class="btn btn-primary" id="btn-random" ng-click="randomPass()">Generate random password</button>
