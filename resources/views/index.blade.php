        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (Auth::user())
                                    <li>
                                    <a href="{{ action("HomeController@redireciona") }}">{{Auth::user()->name}}</a>
                                    </li>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 portfolio-item" ng-repeat="productsbasket in vm.listBk" ng-click="vm.selectedBasket=productsbasket;">
                    <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal" >
                        ...
                        <img src="{{ asset('imgs/portfolio/cart.png') }}" class="img-responsive" alt="">
                    </a>
                    ...
                    <ul class="timeline">
                        <li>
                            <div class="timeline-image">
                                <img class="img-circle img-responsive1" src="{{ asset('imgs/about/ong1.jpg') }}" alt="">
                            </div>
                        ...
                        <li class="timeline-inverted">
                            <div class="timeline-image">
                                <img class="img-circle img-responsive1" src="{{ asset('imgs/about/ong4.jpg') }}" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                        ...
                        <li>
                            <div class="timeline-image">
                                <img class="img-circle img-responsive1" src="{{ asset('imgs/about/ong3.jpg') }}" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>2016-2017</h4>
                        ...
                        <li class="timeline-inverted">
                            <div class="timeline-image">
                                <img class="img-circle img-responsive1" src="{{ asset('imgs/about/ong2.jpg') }}" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>NOW</h4>
 ...
 <section id="team" class="bg-light-gray">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="team-member">
                        ...
                        <img src="{{ asset('imgs/team/salvation.jpg') }}" class="img-responsive img-circle" alt="">
                ...
                <div class="col-sm-3">
                    <div class="team-member">
                        <img src="{{ asset('imgs/team/rita.jpg') }}" class="img-responsive img-circle" alt="">
                ...
                <div class="col-sm-3">
                    <div class="team-member">
                        <img src="{{ asset('imgs/team/estg.png') }}" class="img-responsive img-circle"  alt="">
                        <h4>ESTG - IPVC</h4>
                ...
                <div class="col-sm-3">
                    <div class="team-member">
                        <img src="{{ asset('imgs/team/en.jpg') }}" class="img-responsive img-circle" alt="">
    ...
    <section id="contact">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{action('MailController@basic_email')}}" method="post" >
                    {!! csrf_field() !!}
                        <div class="row">
                            <div class="col-md-6">
